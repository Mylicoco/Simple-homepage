...
themeToggleBtn.addEventListener("click", function () {
  ...
  themeToggleBtn.classList.toggle("hidden");
...
var themeToggleDarkIcon2 = document.querySelector(".theme-toggle-dark-icon2");
var themeToggleLightIcon2 = document.querySelector(".theme-toggle-light-icon2");
...
var themeToggleBtn2 = document.querySelector(".theme-toggle2");

themeToggleBtn2.addEventListener("click", function () {
  // toggle icons inside button
  // themeToggleDarkIcon.classList.toggle("hidden");
  // themeToggleLightIcon.classList.toggle("hidden");
  themeToggleBtn2.classList.toggle("hidden");
  // if set via local storage previously
  if (localStorage.getItem("color-theme")) {
    if (localStorage.getItem("color-theme") === "light") {
      document.documentElement.classList.add("dark");
